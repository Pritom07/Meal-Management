        ...
        <div className="pt-2">
            <header>
                <nav className="flex items-center justify-between">
                    ...
                    <p className="flex items-center"><span><img src="logo.png" className="w-16" /></span><span className="meal md:text-2xl lg:text-3xl sm:text-lg text-violet-700">MEAL-MANAGEMENT</span></p>
                    <ul className={`sidebar md:flex items-center justify-between absolute md:static sm:bg-white bg-[#ffebcd] md:bg-[#ffebcd] text-violet-700 duration-700 grid grid-cols-2 gap-1 sm:px-2  md:pl-3 sm:py-1 ${(isOpen) ? 'top-20' : '-top-32'}`}>
