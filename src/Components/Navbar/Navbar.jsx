        ...
        <div className="pt-2">
            <header>
                <nav className="flex items-center justify-between">
                    ...
                    <ul className={`sidebar md:flex items-center justify-between absolute md:static sm:bg-white bg-[#ffebcd] md:bg-[#ffebcd] text-violet-700 duration-700 grid grid-cols-2 gap-1 sm:px-2 sm:py-1 ${(isOpen) ? 'top-20' : '-top-28'}`}>
