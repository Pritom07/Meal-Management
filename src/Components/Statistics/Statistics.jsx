        ...
        <div>
            {
                (loading) ? ((<div className="flex justify-center items-center h-screen">
                    ...
                    <h1 className="mt-5 text-xl font-medium text-justify px-3">The line chart displayed on the website visualizes the popularity of different cuisines from various countries. The horizontal axis (X-axis) represents the countries, while the vertical axis (Y-axis) shows the popularity scores, measured on a scale from 0 to 100. Each point on the chart corresponds to a country's cuisine, with a connecting line to indicate trends or patterns across the data. For example, cuisines like Italian, French, and Indian show high popularity scores above 90, while Tunisian and Croatian cuisines have lower scores, indicating a lesser popularity compared to others. This chart helps viewers quickly identify and compare the popularity of different international cuisines at a glance.</h1>
                </div>)
            }
        </div >
    );
